...
export default function Nav({ setFilter }) {
  ...
  return (
    <div id="order-page-nav">
      <button type="button" className="btn-status" id="order-page-nav-btn1" onClick={select1}>
        Tất cả
      </button>
      <button type="button" className="btn-status" id="order-page-nav-btn2" onClick={select2}>
        Chờ xác nhận
      </button>
      <button type="button" className="btn-status" id="order-page-nav-btn3" onClick={select3}>
        Đang vận chuyển
      </button>
      <button type="button" className="btn-status" id="order-page-nav-btn4" onClick={select4}>
        Đã giao
      </button>
      <button type="button" className="btn-status" id="order-page-nav-btn5" onClick={select5}>
        Hủy
      </button>
    </div>
  )
